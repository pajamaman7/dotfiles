...
-- ----------------------------------------------------------------------------
  ...
  sm({ trig = "__", name = "Subscript", wordTrig = false }, fmt([[_({}) {}]], { i(1), i(0) }) ),
  sm({ trig = "(%a)nn", name = "x_n", wordTrig = false }, { t("x_n") } ),
  ...
  -- Math fonts
  sm(
    { trig = "(%a)bb", regTrig = true, name = "blackboard quick", dscr = "Auto blackboard bold" },
    fmt([[bb({})]], {
      f(function(_, snip)
        return snip.captures[1]
      end),
  ...
  -- Superscripts
  sm({ trig = "sq", name = "(V) Square Root" }, fmt([[sqrt({}) {}]], { d(1, get_visual), i(0) }) ),
  postfixm({ trig = ".sr", name = "(W) Square Root", priority = 1001 }, {l("sqrt(" .. l.POSTFIX_MATCH .. ") ")} ),

  sm({ trig = "inv", name = "Inverse (^-1)", wordTrig = false }, { t("^(-1)") } ),
  sm({ trig = "sr", name = "Squared (^2)", wordTrig = false }, { t("^2") } ),
  sm({ trig = "cb", name = "Cubed (^3)", wordTrig = false }, { t("^3") } ),
  sm({ trig = "td", name = "To the Power of {exponent}", wordTrig = false }, fmt([[^({}) {}]], { i(1), i(0) }) ),
  ...
  sm({ trig = "to", name = "to" }, { t("arrow ") } ),

  -- Greek
  sm({ trig = "@a", name = "alpha" }, { t("alpha") } ),
  sm({ trig = "@b", name = "beta" }, { t("beta") } ),
  sm({ trig = "@g", name = "gamma" }, { t("gamma") } ),
  sm({ trig = "@d", name = "delta" }, { t("delta") } ),
  sm({ trig = "@D", name = "Delta" }, { t("Delta") } ),
  sm({ trig = "@e", name = "epsilon" }, { t("epsilon") } ),
  sm({ trig = "@g", name = "gamma" }, { t("gamma") } ),
  sm({ trig = "@G", name = "Gamma" }, { t("Gamma") } ),
  sm({ trig = "@i", name = "iota" }, { t("iota") } ),
  sm({ trig = "@l", name = "lambda" }, { t("lambda") } ),
  sm({ trig = "mu", name = "mu" }, { t("mu") } ),
  sm({ trig = "@n", name = "nu" }, { t("nu") } ),
  sm({ trig = "@o", name = "omega" }, { t("omega") } ),
  sm({ trig = "@O", name = "Omega" }, { t("Omega") } ),
  sm({ trig = "pi", name = "pi" }, { t("pi") } ),
  sm({ trig = "@r", name = "rho" }, { t("rho") } ),
  sm({ trig = "@s", name = "sigma" }, { t("sigma") } ),
  sm({ trig = "@S", name = "Sigma" }, { t("Sigma") } ),
  sm({ trig = "@t", name = "tau" }, { t("tau") } ),
  sm({ trig = "@x", name = "xi" }, { t("xi") } ),
  sm({ trig = "@z", name = "zeta" }, { t("zeta") } ),
